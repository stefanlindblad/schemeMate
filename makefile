...
# Link Commands
link:
	g++ -o schemeMate $(bindir)schemeMate_memory.o $(bindir)schemeMate_reader.o $(bindir)schemeMate_printer.o $(bindir)schemeMate_selftest.o $(bindir)schemeMate_main.o
